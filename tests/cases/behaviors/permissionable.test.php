...
final class PermissionableTestCase extends CakeTestCase {
	...
	public function testSave() {
		...
		$this->assertTrue(Set::matches('/ThingPermission[perms=3872]', $result4));
		...
		$this->assertTrue(Set::matches('/ThingPermission[perms=3360]', $result6));
	...
	public function testGetPermission() {
		...
		$this->assertTrue($result1);
		$this->assertEqual($result1['perms'], 3872);
